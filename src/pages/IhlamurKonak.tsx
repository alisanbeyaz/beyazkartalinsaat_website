...
const IhlamurKonak: React.FC = () => {
  const navigate = useNavigate();

  const project = {
    title: "Ihlamur Konakları Florya",
    location: "Florya, İstanbul",
    status: "Tamamlandı",
    mainImage: "/src/projects/florya-ihlamur-konaklari.jpg",
    ...
    coordinates: [40.97886586543963, 28.801308898311177] as [number, number]
  };
