...
const BeyazParkGumussuyu: React.FC = () => {
  ...
  const project = {
    ...
    stats: [
      ...
      { label: "Daire Sayısı", value: "54 Daire", icon: Home },
      { label: "Dükkan Sayısı", value: "11 Dükkan", icon: Home }
    ],
    coordinates: [41.02239416344284, 28.910227718631337] as [number, number]
  };
  ...
  return (
    <PageTransition>
      <div className="bg-slate-50 min-h-screen pb-24">
        ...
        {/* HERO BÖLÜMÜ - Resim netleştirildi */}
...
export default BeyazParkGumussuyu;