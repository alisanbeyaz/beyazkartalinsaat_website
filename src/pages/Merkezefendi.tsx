...
import { Ruler, Home, MapPin, ArrowLeft } from 'lucide-react';
import ProjectMap from '../components/ProjectMap';

const Merkezefendi: React.FC = () => {
  const navigate = useNavigate();

  const project = {
    title: "Merkezefendi Konakları",
    location: "Zeytinburnu, İstanbul",
    status: "Tamamlandı",
    mainImage: "/src/projects/merkez-efendi-konaklari.jpg",
    ...
    coordinates: [41.013998162735575, 28.91899509257373] as [number, number]
  };
