...
import { Ruler, Building, Home, MapPin, ArrowLeft } from 'lucide-react';
import ProjectMap from '../components/ProjectMap';

const Kirkkonak: React.FC = () => {
  ...
  const project = {
    ...
    coordinates: [41.1456, 29.0555] as [number, number]
  };
            ...
            <div className="lg:w-2/3 space-y-16">
              ...
              <div className="bg-white border border-slate-200 shadow-sm p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                {project.stats.map((stat, index) => {
                  ...
                  return (
                    <div 
                    key={index} className="flex flex-col items-center justify-center text-center md:border-r border-slate-100 last:border-r-0 py-2">
